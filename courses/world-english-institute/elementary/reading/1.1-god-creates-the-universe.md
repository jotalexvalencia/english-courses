...
`Dis things cud not` `hav ha-pend bai ak-si-dent` `e-ni mor dan dis` `buk dat iu ar` `ri-ding cud ak-si-den-ta-li fol` `tu-ge-der. E-vri sai-en-ti-fik dis-ca-ve-ri` `givs mor e-vi-dens dat` `a su-pi-ri-or in-te-li-yens pro-diust` `de uorld ui liv` `in. Dat in-te-li-yens is` `God.`

**4. God is personal. In this historical account of creation, God thinks. God moves. God plans. God speaks. God acts. God produces more beauty than any human artist. When we look at the colors in spring flowers, tropical fish, sunsets, and rainbows, we see the handiwork of God. In summary, God has all the qualities of personality.**

`For. God is per-so-nal.` `In dis his-to-ri-cal a-kaunt` `ov cri-ei-shon, God thinks.` `God muvs. God plans.` `God spiks. God akts.` `God pro-diu-ses mor biu-ti` `dan e-ni hiu-man ar-tist.` `Uen ui luk at` `de ca-lors in spring` `flau-ers, tro-pi-cal fish, san-sets,` `and rein-bous, ui si` `de han-di-uerk ov God.` `In sa-ma-ri, God has` `ol de kua-li-tis ov` `per-so-na-li-ti.`

**5. God is the source of life. Some people say that life on Earth has evolved spontaneously. That is, life suddenly appeared millions of years ago without the help of God. According to this theory, nature somehow produced a living cell; from that cell, life has developed into higher and higher forms. This idea is known as "the theory of evolution."**

`Faiv. God is de` `sors ov laif. Sam` `pi-pol sei dat laif` `on Erth has i-volvd` `spon-tei-ni-us-li. Dat is, laif` `sa-den-li a-pird mi-lions ov` `yirs a-go ui-daut de` `help ov God. A-cor-ding` `tu dis thi-o-ri, nei-chur` `sam-hau pro-diust a li-ving` `sel; from dat sel,` `laif has di-ve-lopt in-tu` `hai-er and hai-er forms.` `Dis ai-di-a is noun` `as "de thi-o-ri ov` `e-vo-lu-shon."`

**Many scientists have said "No" to this form of the theory of evolution because it lacks solid evidence to support it. They have carefully examined the fossil records (the bones, shells, and prints left by things that lived and died long ago), and the fossil records contain little or no evidence to support the theory of evolution. Instead, the fossil records show that dogs have always been dogs, monkeys have always been monkeys, and people have always been people. The various forms of life appeared on earth suddenly and fully developed, just as the Bible says.**

`Me-ni sai-en-tists hav sed` `"No" tu dis form` `ov de thi-o-ri ov` `e-vo-lu-shon bi-kos it laks` `so-lid e-vi-dens tu sa-port` `it. Dei hav ke-re-fu-li` `eg-za-mind de fo-sil re-cords` `(de bouns, shels, and` `prints left bai things` `dat livd and daid` `long a-go), and de` `fo-sil re-cords con-tein li-tol` `or no e-vi-dens tu` `sa-port de thi-o-ri ov` `e-vo-lu-shon. Ins-ted, de fo-sil` `re-cords shou dat dogs` `hav ol-ueis bin dogs,` `man-kis hav ol-ueis bin` `man-kis, and pi-pol hav` `ol-ueis bin pi-pol. De` `ve-ri-us forms ov laif` `a-pird on erth sa-den-li` `and fu-li di-ve-lopt, yast` `as de Bai-bol seis.`

**Scientists have also discovered that fire burns out, heat cools, energy is used up, everything decays, and life moves toward death. This discovery (known as the "second law of thermodynamics") argues against the theory of evolution. According to this law, life moves toward death, not toward higher forms of life. Life does not develop on its own power. It is easier to believe that God is the source of life than to believe that life created itself.**

`Sai-en-tists hav ol-so dis-ca-verd` `dat fair burns aut,` `hit culs, e-ner-yi is` `iust ap, e-vri-thing di-keis,` `and laif muvs to-uord` `deth. Dis dis-ca-ve-ri (noun` `as de "se-cond lo` `ov ther-mo-dai-na-mics") ar-guius a-gainst` `de thi-o-ri ov e-vo-lu-shon.` `A-cor-ding tu dis lo,` `laif muvs to-uord deth,` `not to-uord hai-er forms` `ov laif. Laif das` `not di-ve-lop on its` `oun pau-er. It is` `i-si-er tu bi-liv dat` `God is de sors` `ov laif dan tu` `bi-liv dat laif cri-ei-ted` `it-self.`

**6. God owns the world. According to the Bible, the earth belongs to the Lord because he created it and continues to work in it. He stretched out the skies like a curtain. He built the earth and covered it with water like a blanket. God causes water to flow from springs. Streams flow through the valleys, giving us water to drink. God sends rain upon the earth and makes the plants grow. He owns all the animals in the forest and the cattle on a thousand hills. Everything in heaven and on earth belongs to God. The world and all its people are his.**

`Siks. God ouns de` `uerld. A-cor-ding tu de` `Bai-bol, de erth bi-longs` `tu de Lord bi-kos` `hi cri-ei-ted it and` `con-ti-nius tu uerk in` `it. Hi stretcht aut` `de skais laik a` `ker-ten. Hi bilt de` `erth and ca-verd it` `with uo-ter laik a` `blan-ket. God ko-ses uo-ter` `tu flou from springs.` `Strims flou thru de` `va-lis, gi-ving as uo-ter` `tu drink. God sends` `rein a-pon de erth` `and meiks de plants` `grou. Hi ouns ol` `de a-ni-mals in de` `fo-rest and de ka-tol` `on a thou-sand hils.` `E-vri-thing in he-ven and` `on erth bi-longs tu` `God. De uerld and` `ol its pi-pol ar` `his.`
...
`Sins ui bi-long tu` `God, ui mast an-ser` `tu him. God has` `a rait tu in-strakt` `as, and it is` `on-li rait dat ui` `shud o-bei his co-mands.` `Hi is de Lord` `ov he-ven and erth.`

**Now, answer the questions in this lesson.**

`Nau, an-ser de kues-chons` `in dis le-son.`
